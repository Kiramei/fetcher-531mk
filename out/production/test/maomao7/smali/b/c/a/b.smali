...
.method private a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    invoke-direct {v4, v0, v1, v3}, Lb/c/a/b;->c(Landroid/media/ExifInterface;Landroid/media/ExifInterface;Ljava/lang/String;)V
...
.method public onMethodCall(Lio/flutter/plugin/common/MethodCall;Lio/flutter/plugin/common/MethodChannel$Result;)V
    ...
    :try_start_0
    invoke-static {v14}, Lb/c/a/b;->b(Ljava/io/File;)Ljava/lang/String;
    ...
    iget-object v6, v1, Lb/c/a/b;->a:Landroid/content/Context;

    invoke-virtual {v6}, Landroid/content/Context;->getExternalCacheDir()Ljava/io/File;

    move-result-object v6

    invoke-static {v0, v4, v6}, Ljava/io/File;->createTempFile(Ljava/lang/String;Ljava/lang/String;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-virtual {v11, v4}, Ljava/io/ByteArrayOutputStream;->writeTo(Ljava/io/OutputStream;)V

    invoke-direct {v1, v3, v0}, Lb/c/a/b;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v2, v5, v3, v4}, Lio/flutter/plugin/common/MethodChannel$Result;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v12, v0, v7, v13}, Landroid/graphics/Bitmap;->compress(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z

    invoke-virtual {v12}, Landroid/graphics/Bitmap;->recycle()V

    :try_start_3
    invoke-static {v11}, Lb/c/a/b;->b(Ljava/io/File;)Ljava/lang/String;
    ...
    :try_start_4
    invoke-virtual {v13, v4}, Ljava/io/ByteArrayOutputStream;->writeTo(Ljava/io/OutputStream;)V
    ...
    invoke-interface {v2, v5, v3, v6}, Lio/flutter/plugin/common/MethodChannel$Result;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_6
